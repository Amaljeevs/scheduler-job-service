...
public class SendSystemNotifRsHeader {
	...
	public String toString() {
		return "GetCustAccRsHeader [msgFormat=" + msgFormat + ", msgVersion=" + msgVersion + ", requestorChannelId="
	...
	public SendSystemNotifRsHeader(String msgFormat, String msgVersion, String requestorChannelId,
	...
	public SendSystemNotifRsHeader() {
		super();
