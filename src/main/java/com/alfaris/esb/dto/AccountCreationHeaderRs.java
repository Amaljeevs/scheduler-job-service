...
public class AccountCreationHeaderRs {
	...
	public AccountCreationHeaderRs(String msgFormat, String msgVersion, String requestorChannelId,
	...
	public AccountCreationHeaderRs() {
		super();
	...
	public String toString() {
		return "RiyadBankHeaderRs [msgFormat=" + msgFormat + ", msgVersion=" + msgVersion + ", requestorChannelId="
				+ requestorChannelId + ", requestorChannelFunction=" + requestorChannelFunction + ", requestorUserId="
				+ requestorUserId + ", cisNumber=" + cisNumber + ", branchNumber=" + branchNumber + ", tellerId="
				+ tellerId + ", organizationId=" + organizationId + ", ucmId=" + ucmId + ", corporateFlag="
				+ corporateFlag + ", atmCardNumber=" + atmCardNumber + ", creditCardNumber=" + creditCardNumber
				+ ", creditCardNumberMask=" + creditCardNumberMask + ", loginMethod=" + loginMethod + ", terminalId="
				+ terminalId + ", overrideFlag=" + overrideFlag + ", overrideTellerId=" + overrideTellerId
				+ ", journalSeqNumber=" + journalSeqNumber + ", revOp=" + revOp + ", origMsgId=" + origMsgId
				+ ", transactionReference=" + transactionReference + ", severityLevel=" + severityLevel
				+ ", forceTransaction=" + forceTransaction + ", transactionOrigin=" + transactionOrigin
				+ ", sessionOwnerIdType=" + sessionOwnerIdType + ", sessionOwnerId=" + sessionOwnerId
				+ ", requestorLanguage=" + requestorLanguage + ", requestorSecurityInfo=" + requestorSecurityInfo
				+ ", asiReturnCode=" + asiReturnCode + ", mobileNumber=" + mobileNumber + ", sadadappContextId="
				+ sadadappContextId + ", userPrincipalName=" + userPrincipalName + ", customerIntiatedCredit="
				+ customerIntiatedCredit + ", employeeId=" + employeeId + ", descriptionEn=" + descriptionEn
