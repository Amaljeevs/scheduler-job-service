...
public class OutgoingTransferInquiryHeaderRes {
	...
	public OutgoingTransferInquiryHeaderRes(String msgFormat, String msgVersion, String requestorChannelId,
	...
	public OutgoingTransferInquiryHeaderRes() {
		super();
	}
	@Override
	public String toString() {
		return "OutgoingTransferInquiryHeaderRes [msgFormat=" + msgFormat + ", msgVersion=" + msgVersion
