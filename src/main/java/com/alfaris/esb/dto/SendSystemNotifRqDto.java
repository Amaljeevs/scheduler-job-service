...
public class SendSystemNotifRqDto {
	...
	public String toString() {
		return "SendSystemNotifRqDto [riyadBankHeader=" + riyadBankHeader + ", eventType=" + eventType
	...
	public SendSystemNotifRqDto(SendSystemNotifRqHeader riyadBankHeader, String eventType, String iomssEventCd,
