...
public class MoreKeyRs {
	...
	public String toString() {
		return "MoreKeyRs [fromEntCd=" + fromEntCd + ", fromEntKey=" + fromEntKey + ", toEntCd=" + toEntCd
				+ ", toApplCd=" + toApplCd + ", priSecOth=" + priSecOth + ", ownerLiab=" + ownerLiab + ", fromRelCd="
	...
	public MoreKeyRs(String fromEntCd, String fromEntKey, String toEntCd, String toApplCd, String priSecOth,
