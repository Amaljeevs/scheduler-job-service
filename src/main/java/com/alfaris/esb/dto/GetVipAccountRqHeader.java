...
public class GetVipAccountRqHeader {
	...
	public GetVipAccountRqHeader(String msgFormat, String msgVersion, String requestorChannelId,
			...
			String customerIntiatedCredit, String employeeId) {
		super();
		this.msgFormat = msgFormat;
		this.msgVersion = msgVersion;
		this.requestorChannelId = requestorChannelId;
	...
	public String toString() {
		return "GetVipAccountRqHeader [msgFormat=" + msgFormat + ", msgVersion=" + msgVersion + ", requestorChannelId="
				...
				+ customerIntiatedCredit + ", employeeId=" + employeeId + "]";
	}

	public GetVipAccountRqHeader() {
		super();
