...
public class OutgoingTransferInquiryHeaderRq {
	...
	public OutgoingTransferInquiryHeaderRq(String msgFormat, String msgVersion, String requestorChannelId,
			...
			String asiReturnCode, String mobileNumber, String sadadAppContextId, String userDevice, String userIp,
			String userLocation, String userPrincipalName, String customerIntiatedCredit, String employeeId) {
		super();
		this.msgFormat = msgFormat;
		this.msgVersion = msgVersion;
		this.requestorChannelId = requestorChannelId;
	...
	public OutgoingTransferInquiryHeaderRq() {
		super();
	}

	@Override
	public String toString() {
		return "OutgoingTransferInquiryHeaderRq [msgFormat=" + msgFormat + ", msgVersion=" + msgVersion
				...
				+ ", sadadAppContextId=" + sadadAppContextId + ", userDevice=" + userDevice + ", userIp=" + userIp
				+ ", userLocation=" + userLocation + ", userPrincipalName=" + userPrincipalName
