...
public class CustAddLiteRqHeader {
	...
	private String statusDescAr;
		...
		public String toString() {
			return "CustAddLiteRqHeader [serviceName=" + serviceName + ", channelId=" + channelId + ", functionId="
					+ functionId + ", language=" + language + ", messageVersion=" + messageVersion + ", userId="
					+ userId + ", cisNumber=" + cisNumber + ", organizationId=" + organizationId + ", referenceNumber="
					...
					+ ", replyDateTime=" + replyDateTime + ", statusCode=" + statusCode + ", statusDescEn="
					+ statusDescEn + ", statusDescAr=" + statusDescAr + "]";
		}
