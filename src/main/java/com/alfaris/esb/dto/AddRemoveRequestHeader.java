...
public class AddRemoveRequestHeader {
	...
	public AddRemoveRequestHeader(String channelId, String serviceName, String cisNumber, String language,
	...
	public String toString() {
		return "AddRemoveRequestHeader [channelId=" + channelId + ", serviceName=" + serviceName + ", cisNumber="
